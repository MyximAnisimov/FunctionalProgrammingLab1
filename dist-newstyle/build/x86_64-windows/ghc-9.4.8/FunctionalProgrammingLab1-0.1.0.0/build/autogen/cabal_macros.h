...
/* package FunctionalProgrammingLab1-0.1.0.0 */
#ifndef VERSION_FunctionalProgrammingLab1
#define VERSION_FunctionalProgrammingLab1 "0.1.0.0"
#endif /* VERSION_FunctionalProgrammingLab1 */
#ifndef MIN_VERSION_FunctionalProgrammingLab1
#define MIN_VERSION_FunctionalProgrammingLab1(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_FunctionalProgrammingLab1 */
...
#define CURRENT_PACKAGE_KEY "FunctionalProgrammingLab1-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "FunctionalProgrammingLab1-0.1.0.0-inplace"
